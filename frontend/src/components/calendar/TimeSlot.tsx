...
export function TimeSlot({ slot, onRemove }: TimeSlotProps) {
  ...
  return (
    <div
      className="absolute left-1 right-1 rounded bg-gray-100 border border-gray-300 px-1 overflow-hidden group"
      ...
      <div className="flex items-start justify-between">
        ...
        {onRemove && (
          <button
            ...
            className="hidden group-hover:flex h-4 w-4 items-center justify-center rounded text-gray-700 hover:bg-gray-200"
          >
            <X className="h-3 w-3" />
          </button>
        )}
