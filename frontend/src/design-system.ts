...
export const color = {
  ...
  feedback: {
    ...
    errorBg:    "var(--ds-feedback-error-bg)",
    success:    "var(--ds-feedback-success)",
    successBg:  "var(--ds-feedback-success-bg)",
    warning:    "var(--ds-feedback-warning)",
    warningBg:  "var(--ds-feedback-warning-bg)",
    info:       "var(--ds-feedback-info)",
    infoBg:     "var(--ds-feedback-info-bg)",
  },
  avatar: {
...
export const hex = {
  ...
  feedbackErrorBg:    "#FEEDED",
  feedbackSuccess:    "#10684F",
  feedbackSuccessBg:  "#E8F5F0",
  feedbackWarning:    "#D97706",
  feedbackWarningBg:  "#FEF3C7",
  feedbackInfo:       "#1E2A54",
  feedbackInfoBg:     "#EEF0F8",
  avatarNavy:         "#1E2A54",
  avatarTeal:         "#10684F",
  avatarPurple:       "#5F218D",
} as const;
